...
set_sarah_defaults <- function(style = "print",
  ...
  ggplot2::update_geom_defaults("bar", list(fill = "#5445b1"))
  ggplot2::update_geom_defaults("col", list(fill = "#5445b1"))
  ggplot2::update_geom_defaults("point", list(colour = "#5445b1"))
  ggplot2::update_geom_defaults("line", list(colour = "#5445b1"))
  ggplot2::update_geom_defaults("step", list(colour = "#5445b1"))
  ggplot2::update_geom_defaults("path", list(colour = "#5445b1"))
  ggplot2::update_geom_defaults("boxplot", list(fill = "#5445b1"))
  ggplot2::update_geom_defaults("density", list(fill = "#5445b1"))
  ggplot2::update_geom_defaults("violin", list(fill = "#5445b1"))

  # set default colors for monochromatic stats ------------------------------

  ggplot2::update_stat_defaults("count", list(fill = "#5445b1"))
  ggplot2::update_stat_defaults("boxplot", list(fill = "#5445b1"))
  ggplot2::update_stat_defaults("density", list(fill = "#5445b1"))
  ggplot2::update_stat_defaults("ydensity", list(fill = "#5445b1"))
